...
IMAGE_PATH = r"slike\C5_2_Fe2O3003 (1).jpg"
OUTPUT_DIR = "collembolas_C5_2"
os.makedirs(OUTPUT_DIR, exist_ok=True)

df      = pd.read_csv(CSV_PATH)
mask    = df["filename"] == "C5_2_Fe2O3003.jpg"
...
for idx, shape_str in enumerate(regions, start=1):
    ...
    out = os.path.join(OUTPUT_DIR, f"C5_2_Fe2O3003_{idx:03d}.jpg")
